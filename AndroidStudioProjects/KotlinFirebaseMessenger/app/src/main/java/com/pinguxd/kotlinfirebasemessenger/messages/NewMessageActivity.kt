        ...
        ref.addListenerForSingleValueEvent(object: ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                adapter.setOnItemClickListener { item, view ->
                    ...
                    val userItem = item as UserItem // cast the item that was clicked as a UserItem object
...
class UserItem(val user: User): Item<ViewHolder>(){
    // we provide the information to the bind method and set the desired view for our rows
    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.textview_new_message_row.text = user.username
